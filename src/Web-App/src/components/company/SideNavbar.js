    ...
    return (
        <div id="viewport">
            <div id="sidebar" style={{ padding:"0", backgroundColor:"#e2dccd"}}>
              <ul className="nav">
                <li >
                    <Link to="/companydashboard" style={{ width:"100%", borderRadius: "3px", letterSpacing: "1.5px"}}className="btn btn-large waves-effect waves-light hoverable black accent-3">
                        <i className="zmdi zmdi-view-dashboard"></i> My Dashboard
                    </Link>
                </li>
                <li style={{marginTop:"5%"}}>
                    <Link to="/createmanager" style={{width:"100%", borderRadius: "3px", letterSpacing: "1.5px"}}className="btn btn-large waves-effect waves-light hoverable black accent-3">
                        <i className="zmdi zmdi-view-dashboard"></i> Create Manager
                    </Link>
                </li>
                <li style={{marginTop:"5%"}}>
